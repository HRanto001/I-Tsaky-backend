...
public class DonationRepository {
    ...
    public void save(Donation donation) throws SQLException {
        try (Connection conn = dataSource.getConnection()) {
            ...
            // Insérer payment
            String insertPaymentSQL = "INSERT INTO payment (date, amount, method, psp_payment_id, psp_type, payer_email, status) VALUES (?, ?, ?, ?, ?, ?, ?) RETURNING id";
            int paymentId;
    ...
    public List<Donation> findAll() throws SQLException {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            while (rs.next()) {
                ...
                payment.setStatus(Enum.valueOf(ranto.co.io.entity.PaymentStatus.class, rs.getString("status")));
